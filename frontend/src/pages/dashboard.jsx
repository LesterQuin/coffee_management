  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {user?.role?.toLowerCase() === "admin" && (
        <StaffOverview staffList={staffList} />
      )}

      <ChapelsOverview chapelList={chapelList} />
    </div>
  );
}

// ================= Components =================
function StaffOverview({ staffList }) {
...
function ChapelsOverview({ chapelList }) {
  if (chapelList.length === 0) {
    return (
      <div className="bg-white shadow rounded-lg p-4">
